                ...
                <div className="max-w-4xl mx-auto space-y-4">
                  ...
                  <Card>
                    <CardHeader className="relative">
                      ...
                      {!isSVD && (() => { const seg = SEGURADORAS.find(s => s.nome === apolice.seguradora); return seg?.logo ? <img src={seg.logo} alt={seg.nome} className="absolute top-3 right-0 h-20 w-56 object-contain object-right" /> : null; })()}
                    </CardHeader>
