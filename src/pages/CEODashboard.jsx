        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <TabsList className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 h-auto md:h-10 gap-1 bg-white/10 border border-white/20 rounded-lg p-1">
              <TabsTrigger className="text-xs md:text-sm rounded-md text-white/70 data-[state=active]:bg-white data-[state=active]:text-[#003580] data-[state=active]:font-semibold hover:text-white" value="dashboard">Dashboard</TabsTrigger>
              <TabsTrigger className="text-xs md:text-sm rounded-md text-white/70 data-[state=active]:bg-white data-[state=active]:text-[#003580] data-[state=active]:font-semibold hover:text-white" value="empresas">Empresas</TabsTrigger>
              <TabsTrigger className="text-xs md:text-sm rounded-md text-white/70 data-[state=active]:bg-white data-[state=active]:text-[#003580] data-[state=active]:font-semibold hover:text-white" value="solicitacoes">Solicitações</TabsTrigger>
              <TabsTrigger className="text-xs md:text-sm rounded-md text-white/70 data-[state=active]:bg-white data-[state=active]:text-[#003580] data-[state=active]:font-semibold hover:text-white" value="admins">Admins</TabsTrigger>
              <TabsTrigger className="text-xs md:text-sm rounded-md text-white/70 data-[state=active]:bg-white data-[state=active]:text-[#003580] data-[state=active]:font-semibold hover:text-white" value="relatorios">Relatórios</TabsTrigger>
            </TabsList>
          </div>
