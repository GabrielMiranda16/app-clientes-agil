    ...
    if (this.state.error) {
      return (
        <div style={{ padding: '2rem', background: '#fff' }}>
          <div style={{ background: '#fee2e2', border: '1px solid #fca5a5', borderRadius: '8px', padding: '1rem', fontFamily: 'monospace', fontSize: '13px' }}>
            <strong style={{ color: '#b91c1c' }}>Erro capturado (apagar depois):</strong>
            <pre style={{ marginTop: '8px', whiteSpace: 'pre-wrap', color: '#7f1d1d' }}>{this.state.error?.message}{'\n\n'}{this.state.error?.stack}</pre>
          </div>
        </div>
      );
    }
